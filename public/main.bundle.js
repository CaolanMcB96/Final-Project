...
module.exports = "<div class =\"jumbotron text-center\">\n  <h1>Student Attendance App</h1>\n  <p class =\"lead\">Welcome to the student attendacne system applicaton</p>\n  <div>\n    <a class =\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a>\n    <a class =\"btn btn-default\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>\n\n<div class =\"row\">\n  <div class =\"col-sm-4\">\n    <h3>Express Backend</h3>\n    <p>A rock solid Node.js/Express server using Mongoose </p>\n  </div>\n  <div class =\"col-sm-4\">\n    <h3>Angular CLI</h3>\n    <p>Angualr CLI for front end dev</p>\n  </div>\n</div>\n<div class =\"col-sm-4\">\n  <h3>JWT Tokens</h3>\n  <p>Json web tokens for full featured auth</p>\n</div>\n"
...
module.exports = "<h2 class =\"page-header\">Login</h2>\n<form (submit)=\"onLoginSubmit()\">\n  <div class=\"form-group\">\n    <label>Student ID</label>\n    <input type=\"text\" class=\"form-control\" [(ngModel)]=\"Student_ID\" name=\"Student_ID\">\n  </div>\n  <div class=\"form-group\">\n    <label>Password</label>\n    <input type=\"password\" class=\"form-control\" [(ngModel)]=\"password\" name=\"password\">\n  </div>\n  <input type=\"submit\" class=\"btn btn-primary\" value=\"Login\">\n</form>\n"
...
module.exports = "<div *ngIf=\"user\">\n  <h2 class=\"page-header\">{{user.name}}</h2>\n  <ul class=\"list-group\">\n    <li class=\"list-group-item\">Student ID: {{user.Student_ID}}</li>\n    <li class=\"list-group-item\">Email: {{user.email}}</li>\n  </ul>\n</div>\n"
...
var ValidateService = /** @class */ (function () {
    ...
    ValidateService.prototype.validateRegister = function (user) {
        if (user.name == undefined || user.Student_ID == undefined || user.email == undefined || user.password == undefined) {
            return false;
        }
        else {
            return true;
